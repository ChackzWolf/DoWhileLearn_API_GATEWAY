...
const packageDefinition = protoLoader.loadSync(path_1.default.join(__dirname, "../proto/order.proto"), {
    keepCase: true,
    longs: String,
    enums: String,
    defaults: true,
...
const OrderClient = new OrderService(`0.0.0.0:${process.env.ORDER_SERVICE_PORT}`, grpc.credentials.createInsecure(), {
