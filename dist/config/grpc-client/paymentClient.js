...
const packageDefinition = protoLoader.loadSync(path_1.default.join(__dirname, "../proto/Payment.proto"), {
    keepCase: true,
    longs: String,
    enums: String,
    defaults: true,
...
const PaymentClient = new PaymentService(`0.0.0.0:${process.env.PAYMENT_SERVICE_PORT}`, grpc.credentials.createInsecure(), {
